                ...
                <div class="page-header">
                    <div class="row align-items-end">
                        <div class="col-sm mb-2 mb-sm-0">
                            ...
                            <h1 class="page-header-title">Verifikasi {{ $user->name }}</h1>
                        </div>
                        <!-- End Col -->
                    ...
                    <div class="col-lg-9">
                        <div class="d-grid gap-3 gap-lg-5">
                            ...
                            <div class="card">
                                ...
                                <div class="profile-cover">
                                    <div class="profile-cover-img-wrapper">
                                        <img id="profileCoverImg" class="profile-cover-img"
                                            src="/super/img/profile/background.jpg" alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Profile Cover -->
                                ...
                                <label class="avatar avatar-xxl avatar-circle avatar-uploader profile-cover-avatar"
                                    ...
                                    <img id="editAvatarImgModal" class="avatar-img"
                                        src="{{ asset('storage/' . Auth::user()->photo ) }}" alt="Image Description">
                                </label>
                                <!-- End Avatar -->

                                <!-- Body -->
                                <div class="card-body">
                                    <div class="text-center"><span class="mb-2">Pengajuan pada: {{
                                            $user->created_at->format('d M Y'); }}</span></div>
                                    <!-- End Row -->
                                </div>
                                <!-- End Body -->
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <!-- Form -->
                                        <div class="row mb-4">
                                            <label for="name" class="col-sm-3 col-form-label form-label">Nama
                                                Lengkap</label>
                                        ...
                                        <div class="row mb-4">
                                            <label for="nikLabel"
                                                class="col-sm-3 col-form-label form-label">NIK</label>

                                            <div class="col-sm-9">
                                                <input type="nik" class="form-control" name="nik" id="nikLabel"
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="js-input-mask form-control" name="zipCode"
                                                    ...
                                                    aria-label="Your zip code" value="KW5 8NW" data-hs-mask-options='{
                                   "mask": "AA0 0AA"
                                 }'>
                                            </div>
                                        </div>
                            ...
                            <div id="emailSection" class="card">
                                ...
                                <!-- Body -->
                                <div class="card-body">
                                    <p>Your current email address is <span class="fw-semi-bold">mark@site.com</span></p>
                                            ...
                                            <div class="col-sm-9">
                                                <div class="mb-3">
                                                    <input type="password" class="form-control"
                                                        name="confirmNewPassword" id="confirmNewPasswordLabel"
                                        ...
                                        <label class="row form-check form-switch mb-4"
                                            ...
                                            <span class="col-8 col-sm-9 ms-0">
                                                <span class="d-block text-dark mb-1">See info about people who view my
                                                    profile</span>
                                                <span class="d-block fs-5 text-muted"><a class="link" href="#">More
                                                        about viewer info</a>.</span>
                                            </span>
                                            <span class="col-4 col-sm-3 text-end">
                                                <input type="checkbox" class="form-check-input"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="align-items-center">
                                                    <img class="avatar avatar-xss me-2"
                                                        ...
                                                        alt="Image Description"> Chrome on Windows
                                                </td>
                                                <td><i class="bi-laptop fs-3 me-2"></i> Dell XPS 15 <span
                                                        class="badge bg-soft-success text-success ms-1">Current</span>
                                                </td>
                                                <td>London, UK</td>
                                                <td>Now</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="align-items-center">
                                                    <img class="avatar avatar-xss me-2"
                                                        src="./assets/svg/brands/chrome-icon.svg"
                                                        alt="Image Description"> Chrome on Android
                                                </td>
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                ...
                                                                <p class="fs-5 text-body mb-0">Email marketing service
                                                                </p>
                                                            </div>
                                                            <!-- End Col -->
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                ...
                                                                <p class="fs-5 text-body mb-0">Tools for Web Developers
                                                                    <a class="link" href="#">Learn more</a></p>
                                                            </div>
                                                            <!-- End Col -->
