        ...
        <div class="container">
            <div class="row g-4 filter-container overflow-hidden" data-isotope='{"layoutMode": "masonry"}'>
                ...
                <div class="col-sm-6 col-lg-4 grid-item">
                    <div class="card bg-transparent">
                        <div class="overflow-hidden rounded-3">
                            <img src="assets/images/blog/home-1.jpg" class="card-img" alt="course image">
                            <!-- Overlay -->
                ...
                <div class="col-sm-6 col-lg-4 grid-item">
                    <div class="card bg-transparent">
                        <div class="overflow-hidden rounded-3">
                            <img src="assets/images/blog/home-2.jpg" class="card-img-top" alt="course image">
                            <!-- Overlay -->
                            <div class="bg-overlay bg-dark opacity-4"></div>
                            <div class="card-img-overlay d-flex align-items-start p-3">
                                <!-- badge -->
                ...
                <!-- Card item START -->
                <div class="col-sm-6 col-lg-4 grid-item">
                    <div class="card bg-dark p-3" style="background:url(assets/blog/home-4.jpg) no-repeat center center; background-size:cover;">
                        <div class="card-body">
                            <!-- Badge -->
                ...
                <!-- Card item START -->
                <div class="col-sm-6 col-lg-4 grid-item">
                    <div class="card bg-info p-3" style="background:url(assets/images/blog/home-5.jpg) no-repeat center center; background-size:cover;">
                        <div class="card-body">
                            <!-- Title -->
                ...
                <div class="col-sm-6 col-lg-4 grid-item">
                    <div class="card bg-transparent">
                        <div class="overflow-hidden rounded-3">
                            <img src="assets/images/blog/home-3.jpg" class="card-img" alt="course image">
                            <!-- Overlay -->
                            <div class="bg-overlay bg-dark opacity-4"></div>
                            <div class="card-img-overlay d-flex align-items-start p-3">
                                <!-- badge -->
                ...
                <div class="col-sm-6 col-lg-4 grid-item">
                    <div class="card bg-transparent">
                        <div class="overflow-hidden rounded-3">
                            <img src="assets/images/blog/home-4.jpg" class="card-imgp" alt="course image">
                            <!-- Overlay -->
                            <div class="bg-overlay bg-dark opacity-4"></div>
                            <div class="card-img-overlay d-flex align-items-start p-3">
                                <!-- badge -->
