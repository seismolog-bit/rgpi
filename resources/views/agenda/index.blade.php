    ...
    <section class="bg-dark align-items-center d-flex" style="background:url(assets/images/pattern/04.png) no-repeat center center; background-size:cover;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Title -->
                    <h1 class="text-white">Agenda Organisasi</h1>
                    <!-- Breadcrumb -->
                    <div class="d-flex">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-dark breadcrumb-dots mb-0">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Agenda Organsasi</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="card shadow overflow-hidden p-2">
                                <div class="row g-0">
                                    <div class="col-md-5 overflow-hidden">
                                        <img src="assets/images/logo.jpg" class="rounded-2" alt="Card image">
                                        <!-- Ribbon -->
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <!-- Badge -->
                                                <a href="#" class="badge bg-primary text-white mb-2 mb-sm-0">Maret 2022</a>
                                                <!-- Rating and wishlist -->
                                                <div>
                                            ...
                                            <!-- Title -->
                                            <h5 class="card-title"><a href="#">Sosialisasi Kebijakan Organisasi</a></h5>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <!-- Badge -->
                                                <a href="#" class="badge bg-primary text-white mb-2 mb-sm-0">Februari 2022</a>
                                                <!-- Rating and wishlist -->
                                                <div>
                                                    <span class="h6 fw-light me-3"><i class="fas fa-star text-warning me-1"></i>4.5</span>
                                            ...
                                            <!-- Title -->
                                            <h5 class="card-title"><a href="#">Pelantikan DPKW dan DPW Jawa Barat</a></h5>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <!-- Title -->
                                            <h5 class="card-title"><a href="#">Rapat Kerja Organisasi Tingkat Nasional</a></h5>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <!-- Badge -->
                                                <a href="#" class="badge bg-primary text-white mb-2 mb-sm-0">Januari 2022</a>
                                                <!-- Rating and wishlist -->
                                                <div>
                                            ...
                                            <!-- Title -->
                                            <h5 class="card-title"><a href="#">Pelantikan DPP RGPI</a></h5>
